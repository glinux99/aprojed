            ...
            <div class="aiz-sidebar left c-scrollbar">
                <div class="aiz-side-nav-logo-wrap">
                    <a href="/admin" class="d-block text-left d-flex">
                        <img class="" src="{{asset('assets/img/logo-long-bl.png')}}" alt="__('Africa Brand  commerce')" class="mw-100 h-50px h-md-40px" width="200">
                    </a>
                </div>
                <div class="aiz-side-nav-wrap">
                    <div class="px-20px mb-3">
                        <input class="form-control bg-soft-secondary border-0 form-control-sm text-white" type="text" name="" placeholder="__('Rechercher dans le menu')" id="menu-search" onkeyup="menuSearch()">
                    </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="align-items-stretch d-flex dropdown " id="lang-change">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-xs">
                                            ...
                                            <li>
                                                <a href="{{ route('admin.operation.achat')}}" class="dropdown-item">
                                                    __('Achat')
                                                </a>
                                            </li>
                                            <li>
